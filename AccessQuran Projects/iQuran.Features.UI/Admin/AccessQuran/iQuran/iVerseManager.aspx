<%@ Page Language="C#" AutoEventWireup="false" MasterPageFile="~/App_MasterPages/layout.Master" CodeBehind="iVerseManager.aspx.cs" Inherits="iQuran.Web.UI.AdminUI.iVerseManager" %>
...
<div class="modulecontent">
    ...
    <asp:HiddenField ID="hdnSuraID" runat="server" Value="-1" />
    <asp:HiddenField ID="hdnQLang" runat="server" Value="-1" />
<fieldset>
<legend>
...
<asp:HyperLink ID="lnkiVerseManagerAdmin" runat="server" />	
    ...
    <div class="settingrow">
		<mp:SiteLabel ID="SiteLabel2" runat="server" ForControl="ddSelSura" CssClass="settinglabel"
											ResourceFile="iQuranResources" ConfigKey="SelectiSura"></mp:SiteLabel>&nbsp;&nbsp;
		<asp:DropDownList ID="ddSelSura" AutoPostBack="true" DataValueField="SuraID" DataTextField="Title" 
           OnSelectedIndexChanged="ddSelSura_SelectedIndexChanged" runat="server"></asp:DropDownList>&nbsp;&nbsp;
		<mp:SiteLabel 
                     ID="SiteLabel4" runat="server" ForControl="ddSelQuran" CssClass="txterror needsattention"
                    ConfigKey="StarLabel" ResourceFile="iQuranResources" />
		<br />
	</div>
    <div class="settingrow">
...
<!-- Start DATA VIEW -->
    <div class="settingrow">
    <asp:GridView ID="iQVGrid" runat="server"
             AllowPaging="true"
             AllowSorting="true"
             CssClass="editgrid"
	         AutoGenerateColumns="false"
             DataKeyNames="VerseID"
             EnableTheming="false"
	         >
         <Columns>
			 <asp:TemplateField SortExpression="VerseOrder"  ItemStyle-Font-Bold="true" ItemStyle-Wrap="true"  ItemStyle-Width="5%">
                    <HeaderTemplate>
                        <asp:Label Text='<%# Resources.iQuranResources.VerseSortOrderHeader %>' runat="server" ID="label20"  />
                    </HeaderTemplate>
			        <ItemTemplate>
                            <%# Eval("VerseOrder") %>
                    </ItemTemplate>
		        </asp:TemplateField>
		        <asp:TemplateField   ItemStyle-Font-Bold="true" ItemStyle-Wrap="true"  ItemStyle-Width="70%">
                    <HeaderTemplate>
		        ...
		        <asp:TemplateField SortExpression="IsActive">
 		        ...
 		        <asp:TemplateField>
			        ...
			        <ItemTemplate>
                            ...
                            NavigateUrl='<%# SiteRoot + "/Admin/AccessQuran/iQuran/iVerseEdit.aspx?qid=" + Eval("QuranID") + "&sid=" + Eval("SuraID") + "&vid=" + Eval("VerseID") %>'  
                ...
                <asp:TemplateField>
			        ...
			        <ItemTemplate>
                        <asp:ImageButton ImageUrl='<%# DeleteLinkImage %>' CommandArgument='<%# Eval("VerseID") %>' CommandName="delete" 
							AlternateText="<%# Resources.iQuranMessagesResources.DeleteVerseWarning %>" 
							ToolTip="<%# Resources.iQuranMessagesResources.DeleteVerseTip %>" 
